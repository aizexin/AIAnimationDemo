...
{
    return [self GET:URL progress:progress parameters:parameters responseCache:nil success:success failure:failure];
}
...
+ (NSURLSessionTask *)POST:(NSString *)URL
                ...
                parameters:(NSDictionary *)parameters
                   ...
                   failure:(PPHttpRequestFailed)failure
{
    return [self POST:URL progress:progress parameters:parameters responseCache:nil success:success failure:failure];
}
