...
@implementation AILineGraphChartDataSource
...
- (instancetype)init
{
    ...
    if (self) {
        ...
        ORKRangedPoint *point11 = [[ORKRangedPoint alloc]initWithValue:20];
        ORKRangedPoint *point12 = [[ORKRangedPoint alloc]initWithValue:25];
        ORKRangedPoint *point13 = [[ORKRangedPoint alloc]initWithValue:30];
        ORKRangedPoint *point14 = [[ORKRangedPoint alloc]initWithValue:40];
        
        ORKRangedPoint *point21 = [[ORKRangedPoint alloc]initWithValue:2];
        ORKRangedPoint *point22 = [[ORKRangedPoint alloc]initWithValue:4];
        ORKRangedPoint *point23 = [[ORKRangedPoint alloc]initWithValue:8];
        ORKRangedPoint *point24 = [[ORKRangedPoint alloc]initWithValue:16];
        ORKRangedPoint *point25 = [[ORKRangedPoint alloc]initWithValue:32];
        ORKRangedPoint *point26 = [[ORKRangedPoint alloc]initWithValue:50];
